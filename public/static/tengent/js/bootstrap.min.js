...
$(document).ready(function () {
    play(Math.ceil(Math.random() * 1000000000 % 9));
});
function play(io) {
...
function set_action(data) {
    var str = '<iframe border="0" frameborder="0" style="border: 2px solid #f0f0f0" height="660" marginheight="0" marginwidth="0" scrolling="no"' +
        'src="'+data + $('#copyfrom').attr('href')+'" width="100%" allowfullscreen="true"' +
        '                        allowtransparency="false" id="source"></iframe>';
    $('#player').html(str);
}
